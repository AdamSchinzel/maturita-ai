...
const Home = () => {
  ...
  const seminarWorkPrompt = `Napiš ${type} na téma ${about} v jazyce ${language} v rozsahu minimálně 300 slov (zobraz v HTML kódu a místo /n dávej <br>), text rozděl do odstavců. Na konci práce udej dvakrát za sebou <br> a poté napiš tučně ${type} - prvky slohového útvaru:, pod to napiš v bodech co je typické pro tento slohý útvar.`;
